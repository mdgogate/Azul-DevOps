package com.sdp.appazul.expandable;
...
public class CustomizedExpandableListAdapter extends BaseExpandableListAdapter {
    ...
    public Object getChild(int lstPosn, int expandedListPosition) {
        return this.expandableDetailList.get(this.expandableTitleList.get(lstPosn)).get(expandedListPosition);
    }
    ...
    public View getChildView(int lstPosn, final int expanded_ListPosition,
        ...
        TextView expandedListTextView = (TextView) convertView.findViewById(R.id.tvRealAmount);
        TextView tvItem = (TextView) convertView.findViewById(R.id.tvItem);
        String[] splitString = expandedListText.split(",");
        expandedListTextView.setText(splitString[0]);
        tvItem.setText(splitString[1]);
        return convertView;
    }
