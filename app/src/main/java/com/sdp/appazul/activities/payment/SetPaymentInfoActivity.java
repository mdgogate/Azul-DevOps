...
public class SetPaymentInfoActivity extends AppCompatActivity {
    TextView tvAmount;
    ...
    private void initControls() {
        ...
        if (locationFilter != null) {
            ...
            mID = lastLocationMid;
            tvSelectedPaymentLocation.setText(lastLocationName);
        }

        paymentLocationSelector.setOnClickListener(paymentLocationSelectorView -> {
            bottomsheet = new LocationFilterBottomSheet(locationJson, "SET_PAYMENT");
        ...
        tvFinalAmount.setOnClickListener(tvFinalAmountView -> {
            Intent intent = new Intent(SetPaymentInfoActivity.this, PaymentConfirmaActivity.class);
    ...
    public void setContent(String content, String merchantId, int dimissFlag) {
        tvSelectedPaymentLocation.setText(content);
        mID = merchantId;
        if (dimissFlag == 1) {
            bottomsheet.dismiss();
        }
